function [lat_res, lon_res, alt_res] = Fetch_Position2()
...
%% calculation
for idx = 101 :1: 510 % 612
     if(mod(idx,100) > 10) continue;
     end
    idx_str = num2str(idx);
    obj_path = '*/Satellite/Satellite';
    obj_path = strcat(obj_path, '2'); % satellite2
...
%% export
save('C:/Users/humingzhe/Desktop/position_data/lat2.mat','lat_res');
save('C:/Users/humingzhe/Desktop/position_data/lon2.mat','lon_res');
save('C:/Users/humingzhe/Desktop/position_data/alt2.mat','alt_res');
%%
stkClose('all');
